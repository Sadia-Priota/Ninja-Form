...
class Recommended_Plugins {
    ...
    public function plugin_activation() {
        ...
        if(wp_verify_nonce($ajax_nonce, 'htrp_cf7_activation_nonce')) {
            if ( ! current_user_can( 'install_plugins' ) || ! isset( $_POST['location'] ) || ! sanitize_url($_POST['location']) ) {
                wp_send_json_error(
                    array(
                        'success' => false,
            ...
            $plugin_location = ( isset( $_POST['location'] ) ) ? sanitize_url($_POST['location']) : '';
